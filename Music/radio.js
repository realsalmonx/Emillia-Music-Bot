  ...
  async execute(message, args, client) {
    ...
    let resultsEmbed = new Discord.MessageEmbed()
        .setTitle(`**<:Playing:822858092496683028> Available Radio Stations**`)//
        .addFields(
          { name: `***<:emoji_29:822858014981095475> Standard Radio***`, value: `**1:  ** [\`${Radiostations[1-1].split(" ")[0]}\`](${Radiostations[1-1].split(" ")[1]})
          ...
          **5:  ** [\`${Radiostations[5-1].split(" ")[0]}\`](${Radiostations[5-1].split(" ")[1]})
          ` , inline: true}, { name: `***<:emoji_29:822858014981095475> Standard Radio***`, value: `**6:  ** [\`${Radiostations[6-1].split(" ")[0]}\`](${Radiostations[6-1].split(" ")[1]})
  ...
  **34: ** [\`${Radiostations[34-1].split(" ")[0]}\`](${Radiostations[34-1].split(" ")[1]})`, inline: true },
  ...
  message.channel.send(new MessageEmbed().setColor("#c219d8")
  .setDescription(`**<:youtube:822857582729363466> Searching 🔍 \`${Radiostations[i-1].split(" ")[0]}\`**`));
  //mute yourself
