  ...
  let thumb;
    ...
    try {
      const newsong = new MessageEmbed()
        .setTitle("<:Playing:822858092496683028>  "+song.title)
        .setURL(song.url)
        .setColor("#c219d8")
        .setThumbnail(thumb)
      ...
      await playingMessage.react("822857869757513779"); //skip
      await playingMessage.react("822857901931888660"); //pause
      await playingMessage.react("822857929102852138"); //loop
      await playingMessage.react("822857996165447681"); //stop
      await playingMessage.react("822858114461990963"); //np
      await playingMessage.react("822858038448357407"); //queue
      await playingMessage.react("822858163337822219"); //lyrics
    } catch (error) {
      console.error(error);
    }
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      if (member.voice.channel !== member.guild.me.voice.channel) {
        ...
        .setTitle("<:emoji_35:822858134464102400> | You must be in the Same Voice Channel as me!")
        .setColor("#ff0e7a"))
      ...
      switch (reaction.emoji.id) {
        ...
        case "822858163337822219":
          ...
          let lyricsEmbed = new MessageEmbed()
            .setTitle("<:emoji_36:822858163337822219> Lyrics")
